...
countries.features = countries.features.filter(function (item) {
    return visited.visited.includes(item.properties.name_long) || visited.planning.includes(item.properties.name_long) || visited.never.includes(item.properties.name_long)
});
